/* Here is a second test that will run when "go test -v -timeout 30m" command is issued in the test folder.
...
func Test2_ComplexValues(t *testing.T) {
	//	t.Parallel()
	...
	******************************************************************************************************/
	...
	testvars := "<name of variables file, such as test2.tfvars>"
