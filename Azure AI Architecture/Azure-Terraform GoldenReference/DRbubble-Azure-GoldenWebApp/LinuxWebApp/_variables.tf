...
variable "use_go" {
  type        = bool
  description = "Use go programming language."
  default     = false
}
variable "go_version" {
  type        = string
...
variable "dotnet_version" {
  type        = string
  description = "The version of .NET to use. Possible values include 3.1, 5.0, 6.0, 7.0 and 8.0."
  default     = null
}
...
variable "use_java_server" {
  type        = bool
  description = "Use Java Server."
  default     = false
}
...
variable "node_version" {
  type        = string
  description = "The version of Node to run. Possible values include 12-lts, 14-lts, 16-lts, 18-lts and 20-lts. This property conflicts with java_version."
  default     = null
}
...
variable "python_version" {
  type        = string
  description = ") The version of Python to run. Possible values include 3.9, 3.10, 3.11 and 3.12."
  default     = null
}

variable "use_ruby" {
  type        = bool
  description = "Specifies whether this is a Ruby app."
  default     = false
}
...
variable "web_app_slot" {
  ...
  type = object({
    ...
    #auto_swap_slot_name                           = optional(string,null) Auto swap isn't supported in web apps on Linux
