resource "azurerm_linux_web_app_slot" "slot" {
  ...
  ApplicationInsightsAgent_EXTENSION_VERSION = "~3" }) : var.web_app_slot.app_settings
  ...
  site_config {
    ...
    #auto_swap_slot_name               = var.web_app_slot.auto_swap_slot_name #Auto swap isn't supported in web apps on Linux
