locals {
  ...
  use_application_stack = var.use_docker || var.use_dotnet || var.use_go || var.use_java || var.use_node || var.use_php || var.use_python || var.use_ruby
