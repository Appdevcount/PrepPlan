...
func Test2_LinuxVM(t *testing.T) {
	//	t.Parallel()

	/******************************************************************************************************
		Test 2 - Deploy standard Linux and Windows VMs from Azure Compute Gallery, using a VNet in separate
		         Resource Group for the nics.
	******************************************************************************************************/
	testpath := "./TestEnvironment"
	testvars := "testVMsDiffVnet.tfvars"
