...
func TestCase1(t *testing.T) {
	...
	******************************************************************************************************/
	...
	testvars := "twoKeysOneDiskEncryptionSet.tfvars"
	expectresults := []string{
		...
		"module.Azure-GoldenKeyVault.azurerm_disk_encryption_set.disk_encryption_sets[\"des_workloada\"]: Creation complete",
		"module.Azure-GoldenKeyVault.azurerm_role_assignment.key_vault_role_assignment[\"des_workloada\"]: Creation complete",
