...
variable "java_version" {
  type = string
  description = "The Version of Java to use. Supported versions include 8, 11 & 17."
  default = "17"
}
...
variable "powershell_core_version" {
  type = string
   description = "The version of PowerShell Core to run. Possible values are 7, 7.2, and 7.4."
   default = "7.2"
}
