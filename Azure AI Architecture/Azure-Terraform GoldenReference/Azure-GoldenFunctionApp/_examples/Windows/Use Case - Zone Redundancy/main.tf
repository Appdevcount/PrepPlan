...
module "GoldenWindowFuncApp" {
    ...
    app_scale_limit                   = 4
    app_worker_count                  = 3 #If Zone redundancy is enabled in ASP, the worker_count should equal the number of zones in the selected region.
