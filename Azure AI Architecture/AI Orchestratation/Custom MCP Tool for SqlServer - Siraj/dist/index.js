        ...
        tools: [
            {
                ...
                description: "Connect to a local SQL database (SQLite or SQL Server)",
                inputSchema: {
                    type: "object",
                    properties: {
                        type: {
                        ...
                        server: {
                            type: "string",
                            description: "SQL Server address (required for mssql, default: localhost)",
                        },
                        database: {
                            type: "string",
                            description: "Database name (required for mssql, default: master)",
                        },
                        username: {
                            type: "string",
