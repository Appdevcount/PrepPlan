...
| 20–35 min | Classes, Interfaces, and Dependency Inversion |
| 35–45 min | Async/Await — The Mental Model |
| 45–55 min | Null Safety & Modern C# Shortcuts |
...
## 3. Classes, Interfaces, and Dependency Inversion (20–35 min)
...
2. **Interfaces are contracts** — always code to an interface, not a concrete class.
3. **Records for data** — use `record` for DTOs; they are immutable and self-documenting.
4. **Async/await = non-blocking I/O** — never use `.Result` or `.Wait()`.
5. **`?` means nullable** — the compiler helps you avoid null-reference exceptions.
